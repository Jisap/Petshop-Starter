    ...
    <section className="bg-adoption bg-cover bg-no-repeat min-h-[760px] py-8 flex">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center gap-x-16">
        ...
        <div className="flex-1 text-cream text-center max-w-md lg:text-left lg:max-w-none">
          <h2 className="h2 mb-6 ">Makin pet parenting easy for everyone</h2>
          <p className='mb-6'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis illo nemo fuga sit voluptatibus consequuntur doloribus voluptates quaerat esse nam ea odio veniam, dolores, laborum illum dicta iusto aspernatur quibusdam?</p>
